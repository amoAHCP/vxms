...
public class EventbusRequest {
   ...
   *
   * @return the blocking chain {@link org.jacpfx.vxms.rest.base.eventbus.blocking.EventbusRequest}
   */
  public org.jacpfx.vxms.rest.base.eventbus.blocking.EventbusRequest blocking() {
    return new org.jacpfx.vxms.rest.base.eventbus.blocking.EventbusRequest(
