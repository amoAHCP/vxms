...
public class ResolveServicesByLabelsConfigAndPortOKOfflineTest extends VertxTestBase {
        ...
        client.get(
            ...
            resp -> {
              resp.bodyHandler(body -> {
                ...
                vertx.runOnContext(
                    context -> {
                      failed.set(!response.equalsIgnoreCase("tcp://192.168.1.1:8080/http://192.168.1.2:9080"));
