...
public class ResolveServicesByNameTest extends VertxTestBase {
 ...
 // public DefaultKubernetesClient client;
  ...
  public void initService() {
    ...
    server.expect().withPath("/api/v1/namespaces/default/services").andReturn(200, new ServiceListBuilder().addToItems().addToItems(servicemyTestService,servicemyTestService2).build()).times(2);
