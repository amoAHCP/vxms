...
public class EventbusFailureTests extends VertxTestBase {
  ...
  public class WsServiceOne extends VxmsEndpoint {
    ...
    public void simpleStringResponseFailure(EventbusHandler reply) {
      ...
      reply
          ...
          .onFailureRespond((t, f) -> f.complete(t.getMessage()))
          .execute();
    }
    ...
    public void simpleObjectResponseFailure(EventbusHandler reply) {
      ...
      reply
          ...
          .onFailureRespond(
              (t, f) -> f.complete(new Payload<>(t.getMessage() + "NPE")), new ExampleByteEncoder())
          .execute();
    }
