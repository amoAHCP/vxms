...
public class RESTVerticleRouteBuilderClientTimeoutTests extends VertxTestBase {
  ...
  public class WsServiceOne extends AbstractVerticle {
      ...
      public void start(io.vertx.core.Future<Void> startFuture) throws Exception {
          VxmsRESTRoutes routes =
                  VxmsRESTRoutes.init()
                          .route(RouteBuilder.get("/simpleTimeoutTest", this::simpleTimeoutTest))
                          .route(RouteBuilder.get("/simpleTimeoutNonBlockingTest", this::simpleTimeoutNonBlockingTest))
                          .route(RouteBuilder.get("/eventbusTimeoutNonBlockingTest", this::eventbusTimeoutNonBlockingTest))
                          .route(RouteBuilder.get("/long", this::longRunner));
    ...
    public void eventbusTimeoutNonBlockingTest(RestHandler reply) {
      ...
      reply
          .eventBusRequest()
          .send("hello", "payload", new DeliveryOptions().setSendTimeout(500))
          .mapToStringResponse(
              (message, future) -> {
