...
public class RESTVerticleRouteBuilderClientTests extends VertxTestBase {
  ...
  public class WsServiceOne extends AbstractVerticle {
      ...
      public void start(io.vertx.core.Future<Void> startFuture) throws Exception {
          VxmsRESTRoutes routes =
                  VxmsRESTRoutes.init()
                          .route(RouteBuilder.get("/stringGETResponse", this::rsstringGETResponse))
                          .route(RouteBuilder.post("/stringPOSTResponse", this::rsstringPOSTResponse))
                          .route(RouteBuilder.options("/stringOPTIONSResponse", this::rsstringOPTIONSResponse))
                          .route(RouteBuilder.put("/stringPUTResponse", this::rsstringPUTResponse))
                          .route(RouteBuilder.delete("/stringDELETEResponse", this::rsstringDELETEResponse))
                          .route(RouteBuilder.post("/stringPOST", this::rsstringPOST))
                          .route(RouteBuilder.post("/stringPOSTNoEnd", this::rsstringPOSTNoEnd))
                          .route(RouteBuilder.get("/stringGETResponseWithParameter/:help", this::rsstringGETResponseWithParameter))
                          .route(RouteBuilder.post("/stringPOSTResponseWithParameter/:help", this::rsstringPOSTResponseWithParameter));
