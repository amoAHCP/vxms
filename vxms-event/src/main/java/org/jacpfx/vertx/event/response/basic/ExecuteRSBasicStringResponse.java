...
public class ExecuteRSBasicStringResponse extends ExecuteRSBasicString {
    ...
    public ExecuteRSBasicStringResponse(String methodId, Vertx vertx, Throwable t, Consumer<Throwable> errorMethodHandler, Message<Object> message,
    ...
    public ExecuteRSBasicStringResponse onError(Consumer<Throwable> errorHandler) {
        return new ExecuteRSBasicStringResponse(methodId, vertx, t, errorMethodHandler, message, stringConsumer, excecuteEventBusAndReply,  errorHandler, onFailureRespond, deliveryOptions, retryCount, timeout, circuitBreakerTimeout);
    }
    ...
    public ExecuteRSBasicStringCircuitBreaker retry(int retryCount) {
        return new ExecuteRSBasicStringCircuitBreaker(methodId, vertx, t, errorMethodHandler, message, stringConsumer, excecuteEventBusAndReply, errorHandler, onFailureRespond,
     ...
     * @return the response chain
     */
    public ExecuteRSBasicStringResponse onFailureRespond(ThrowableErrorConsumer<Throwable, String> onFailureRespond) {
        return new ExecuteRSBasicStringResponse(methodId, vertx, t, errorMethodHandler, message, stringConsumer, excecuteEventBusAndReply, errorHandler, onFailureRespond, deliveryOptions, retryCount, timeout, circuitBreakerTimeout);
    }
