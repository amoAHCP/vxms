...
public class EventbusAsyncObjectExecutionUtil {
    ...
    public static ExecuteRSObjectResponse mapToObjectResponse(String _methodId, String _id, Object _message, DeliveryOptions _options,
                                                              ...
                                                              ThrowableFunction<Throwable, Serializable> _errorHandlerObject, int _httpStatusCode, int _httpErrorCode, int _retryCount, long _timeout, long _delay, long _circuitBreakerTimeout) {
        ...
        final ExecuteEventBusObjectCallAsync excecuteEventBusAndReply = (vertx, t, errorMethodHandler,
                ...
                sendMessageAndSupplyObjectHandler(_methodId, _id, _message, _objectFunction, deliveryOptions, vertx, t,
                        errorMethodHandler, context, headers, encoder, errorHandler, errorHandlerObject, httpStatusCode, httpErrorCode, retryCount, timeout, delay, circuitBreakerTimeout);
        ...
        return new ExecuteRSObjectResponse(_methodId, _vertx, _t, _errorMethodHandler, _context, _headers, _objectSupplier, excecuteEventBusAndReply,
                _encoder, _errorHandler, _errorHandlerObject, _httpStatusCode, _httpErrorCode, _retryCount, _timeout, _delay, _circuitBreakerTimeout);
    }
    ...
    private static void sendMessageAndSupplyObjectHandler(String methodId, String id, Object message,
                                                          ...
                                                          Encoder encoder, Consumer<Throwable> errorHandler, ThrowableFunction<Throwable, Serializable> errorHandlerObject,
        ...
        if (circuitBreakerTimeout == 0l) {
            executeDefaultState(methodId, id, message, objectFunction, deliveryOptions, vertx, t, errorMethodHandler, context, headers, encoder,
                    errorHandler, errorHandlerObject, httpStatusCode, httpErrorCode, retryCount, timeout, delay, circuitBreakerTimeout, null);
        } else {
            executeStateful(methodId, id, message, objectFunction, deliveryOptions, vertx, t, errorMethodHandler, context, headers, encoder,
                    errorHandler, errorHandlerObject, httpStatusCode, httpErrorCode, retryCount, timeout, delay, circuitBreakerTimeout);
        }
    ...
    private static void executeStateful(String methodId, String id, Object message, ThrowableFunction<AsyncResult<Message<Object>>, Serializable> objectFunction,
                                        ...
                                        ThrowableFunction<Throwable, Serializable> onFailureRespond, int httpStatusCode, int httpErrorCode, int retryCount, long timeout, long delay, long circuitBreakerTimeout) {
        ...
        executeLocked(((lock, counter) ->
                counter.get(counterHandler -> {
                    ...
                    if (currentVal == 0) {
                        ...
                        executeDefaultState(methodId, id, message, objectFunction, deliveryOptions, vertx, t, errorMethodHandler, context, headers, encoder, errorHandler, onFailureRespond,
                                httpStatusCode, httpErrorCode, retryCount, timeout, delay, circuitBreakerTimeout, lock);
                    } else {
    ...
    private static void executeInitialState(String methodId, String id, Object message, ThrowableFunction<AsyncResult<Message<Object>>, Serializable> objectFunction,
                                            ...
                                            Encoder encoder, Consumer<Throwable> errorHandler, ThrowableFunction<Throwable, Serializable> onFailureRespond,
    ...
    private static void executeDefaultState(String methodId, String id, Object message, ThrowableFunction<AsyncResult<Message<Object>>, Serializable> objectFunction,
                                            ...
                                            Map<String, String> headers, Encoder encoder, Consumer<Throwable> errorHandler, ThrowableFunction<Throwable, Serializable> onFailureRespond,
    ...
    private static void createObjectSupplierAndExecute(String methodId, String id, Object message, DeliveryOptions deliveryOptions,
        ...
        final ThrowableSupplier<Serializable> objectSupplier = createObjectSupplier(methodId, id, message, deliveryOptions, objectFunction, vertx, t,
                errorMethodHandler, context, headers, encoder, errorHandler, errorHandlerObject, httpStatusCode, httpErrorCode, retryCount, timeout, delay, circuitBreakerTimeout, event);

        if (circuitBreakerTimeout == 0l) {
            statelessExecution(methodId, id, message, deliveryOptions, objectFunction, vertx, t, errorMethodHandler, context, headers, encoder, errorHandler, errorHandlerObject, httpStatusCode, httpErrorCode, retryCount, timeout, delay, circuitBreakerTimeout, event, objectSupplier);

        } else {
            statefulExecution(methodId, id, message, objectFunction, deliveryOptions, vertx, t, errorMethodHandler, context, headers, encoder, errorHandler, errorHandlerObject, httpStatusCode, httpErrorCode, retryCount, timeout, delay, circuitBreakerTimeout, event, objectSupplier);

        }
    }

    private static void statelessExecution(String methodId, String id, Object message, DeliveryOptions deliveryOptions, ThrowableFunction<AsyncResult<Message<Object>>, Serializable> objectFunction,
                                           ...
                                           ThrowableFunction<Throwable, Serializable> errorHandlerObject, int httpStatusCode, int httpErrorCode, int retryCount, long timeout, long delay, long circuitBreakerTimeout, AsyncResult<Message<Object>> event, ThrowableSupplier<Serializable> objectSupplier) {
        if (event.succeeded() || (event.failed() && retryCount <= 0)) {
            new ExecuteRSObjectResponse(methodId, vertx, t, errorMethodHandler, context, headers, objectSupplier, null,
                    encoder, errorHandler, errorHandlerObject, httpStatusCode, httpErrorCode, retryCount, timeout, delay, circuitBreakerTimeout).execute();
        } else if (event.failed() && retryCount > 0) {
            retryObjectOperation(methodId, id, message, deliveryOptions, objectFunction, vertx, t, errorMethodHandler, context, headers, encoder, errorHandler, errorHandlerObject, httpStatusCode, httpErrorCode, retryCount, timeout, delay, circuitBreakerTimeout);
        }
    }
    ...
    private static void openCircuitAndHandleError(String methodId, Vertx vertx, Consumer<Throwable> errorMethodHandler, RoutingContext context, Map<String, String> headers, Encoder encoder,
                                                  Consumer<Throwable> errorHandler, ThrowableFunction<Throwable, Serializable> onFailureRespond, int httpStatusCode, int httpErrorCode, int retryCount, long timeout,
    ...
    private static void handleError(String methodId, Vertx vertx, Consumer<Throwable> errorMethodHandler, RoutingContext context, Map<String, String> headers, Encoder encoder, Consumer<Throwable> errorHandler,
                                    ThrowableFunction<Throwable, Serializable> onFailureRespond, int httpStatusCode, int httpErrorCode, int retryCount, long timeout, long delay, long circuitBreakerTimeout, Lock lock, Throwable cause) {
        Optional.ofNullable(lock).ifPresent(Lock::release);
    ...
    private static void retryObjectOperation(String methodId, String id, Object message, DeliveryOptions deliveryOptions, ThrowableFunction<AsyncResult<Message<Object>>, Serializable> objectFunction, Vertx vertx, Throwable t,
                                             Consumer<Throwable> errorMethodHandler, RoutingContext context, Map<String, String> headers, Encoder encoder, Consumer<Throwable> errorHandler, ThrowableFunction<Throwable, Serializable> errorHandlerObject,
                                             int httpStatusCode, int httpErrorCode, int retryCount, long timeout, long delay, long circuitBreakerTimeout) {
        mapToObjectResponse(methodId, id, message, deliveryOptions, objectFunction, vertx, t, errorMethodHandler, context, headers, null, encoder, errorHandler, errorHandlerObject, httpStatusCode, httpErrorCode, retryCount - 1, timeout, delay, circuitBreakerTimeout).
                execute();
    }
    ...
    private static void executeLocked(LockedConsumer consumer, String _methodId, Vertx vertx, Consumer<Throwable> errorHandler,
                                      ThrowableFunction<Throwable, Serializable> onFailureRespond, Consumer<Throwable> errorMethodHandler,
