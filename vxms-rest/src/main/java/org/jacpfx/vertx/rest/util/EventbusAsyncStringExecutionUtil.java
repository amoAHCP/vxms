...
public class EventbusAsyncStringExecutionUtil {
    ...
    public static ExecuteRSStringResponse mapToStringResponse(String _id, Object _message, DeliveryOptions _options,
        ...
        final ExecuteEventBusStringCallAsync excecuteAsyncEventBusAndReply = (vertx, t, errorMethodHandler,
                ...
                sendMessageAndSupplyStringHandler(_id, _message, _options, _stringFunction, deliveryOptions, vertx, t, errorMethodHandler, context, headers, encoder, errorHandler, errorHandlerString, httpStatusCode, retryCount, timeout, delay);
    ...
    private static void createStringSupplierAndExecute(String id, Object message, DeliveryOptions options,
        ...
        final ThrowableSupplier<String> stringSupplier = createStringSupplier(id, message, options, stringFunction,
        ...
        if (!event.failed() || (event.failed() && retryCount <= 0)) {
            ...
            retryStringOperation(id, message, options, stringFunction, vertx, t, errorMethodHandler, context, headers, encoder, errorHandler, errorHandlerString, httpStatusCode, retryCount, timeout, delay);
        }
    }

    private static void retryStringOperation(String id, Object message, DeliveryOptions options, ThrowableFunction<AsyncResult<Message<Object>>, String> stringFunction, Vertx vertx, Throwable t, Consumer<Throwable> errorMethodHandler, RoutingContext context, Map<String, String> headers, Encoder encoder, Consumer<Throwable> errorHandler, Function<Throwable, String> errorHandlerString, int httpStatusCode, int retryCount, long timeout, long delay) {
        mapToStringResponse(id, message, options, stringFunction, vertx, t, errorMethodHandler, context, headers, null, encoder, errorHandler, errorHandlerString, httpStatusCode, retryCount - 1, timeout, delay).
                execute();
    }


    private static ThrowableSupplier<String> createStringSupplier(String id, Object message, DeliveryOptions options, ThrowableFunction<AsyncResult<Message<Object>>, String> stringFunction, Vertx vertx, Throwable t,
                                                                  Consumer<Throwable> errorMethodHandler, RoutingContext context, Map<String, String> headers, Encoder encoder,
                                                                  Consumer<Throwable> errorHandler, Function<Throwable, String> errorHandlerString, int httpStatusCode, int retryCount, long timeout, long delay, AsyncResult<Message<Object>> event) {
        return () -> {
            String resp = null;
