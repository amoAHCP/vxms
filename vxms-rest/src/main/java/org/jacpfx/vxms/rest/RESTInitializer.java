...
public class RESTInitializer {
  ...
  private static void initHttpOperation(String methodId, VxmsShared vxmsShared, Object service,
      Method restMethod, Route route, Stream<Method> errorMethodStream, Optional<Consumes> consumes,
      Class<? extends Annotation> httpAnnotation) {
    final Optional<Method> errorMethod = errorMethodStream
  ...
  private static void initHttpAll(VxmsShared vxmsShared, Router router, Object service,
      Method restMethod, Path path, Stream<Method> errorMethodStream, Optional<Consumes> consumes) {
  ...
  private static void initHttpRoute(String methodId, VxmsShared vxmsShared, Object service,
      Method restMethod, Optional<Consumes> consumes, Optional<Method> errorMethod, Route route) {
  ...
  private static Object[] getInvocationParameters(String methodId, VxmsShared vxmsShared,
      Object service, Method restMethod, Optional<Method> onErrorMethod,
      RoutingContext routingContext) {
    final Consumer<Throwable> throwableConsumer = throwable -> handleRestError(methodId + "ERROR",
  ...
  private static void handleRestError(String methodId, VxmsShared vxmsShared, Object service,
      Optional<Method> onErrorMethod, RoutingContext routingContext, Throwable throwable) {
