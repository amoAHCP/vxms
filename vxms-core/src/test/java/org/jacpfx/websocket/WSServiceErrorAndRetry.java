...
public class WSServiceErrorAndRetry extends VertxTestBase {
  ...
  public class WsServiceOne extends VxmsEndpoint {
    ...
    public void wsEndpointObjectUncatchedErrorOnError(Throwable t, WebSocketHandler reply,
    ...
    public void wsEndpointObjectUnCatchedObjectErrorOnError(Throwable t, WebSocketHandler reply,
        WebSocketEndpoint endpoint) {
      t.printStackTrace();
      System.out.println("----failover");
      reply.
    ...
    public void wsEndpointObjectSimpleOnErrorOnError(Throwable t, WebSocketHandler reply,
        WebSocketEndpoint endpoint) {
      t.printStackTrace();
      System.out.println("----failover");
      reply.
    ...
    public void wsEndpointStringUncatchedErrorOnError(Throwable t, WebSocketHandler reply,
        WebSocketEndpoint endpoint) {
      t.printStackTrace();
      System.out.println("----failover");
      reply.
    ...
    public void wsEndpointUncatchedErrorOnErrorAsync(Throwable t, WebSocketHandler reply,
        WebSocketEndpoint endpoint) {
      t.printStackTrace();
      System.out.println("----failover");
      reply.
    ...
    public void wsEndpointUncatchedTimeoutErrorOnErrorAsync(Throwable t, WebSocketHandler reply,
        WebSocketEndpoint endpoint) {
      t.printStackTrace();
      System.out.println("----failover");
      reply.
    ...
    public void wsEndpointUncatchedTimeoutErrorOnErrorException(Throwable t, WebSocketHandler reply,
        WebSocketEndpoint endpoint) {
      t.printStackTrace();
      System.out.println("----failover");
      reply.
    ...
    public void wsEndpointUncatchedMethodError(Throwable t, WebSocketHandler reply,
        WebSocketEndpoint endpoint) {
      t.printStackTrace();
      System.out.println("----failover");
      reply.
