...
public class RESTServiceUnhandledExceptionsTest extends VertxTestBase {
    ...
    public void unhandledException() throws InterruptedException {
        ...
        HttpClientRequest request = client.get("/wsService/unhandledException?val=123&tmp=456", new Handler<HttpClientResponse>() {
    ...
    public void unhandledExceptionWithRetry() throws InterruptedException {
        ...
        HttpClientRequest request = client.get("/wsService/unhandledExceptionWithRetry?val=123&tmp=456", new Handler<HttpClientResponse>() {
            public void handle(HttpClientResponse resp) {
                resp.bodyHandler(body -> {
                    String val = body.getString(0, body.length());
                    System.out.println("--------exceptionInStringResponse: " + val+"  CODE: "+resp.statusCode());
    ...
    public void unhandledExceptionBlocking() throws InterruptedException {
        ...
        HttpClientRequest request = client.get("/wsService/unhandledExceptionBlocking?val=123&tmp=456", new Handler<HttpClientResponse>() {
            public void handle(HttpClientResponse resp) {
                resp.bodyHandler(body -> {
                    String val = body.getString(0, body.length());
                    System.out.println("--------exceptionInStringResponse: " + val+"  CODE: "+resp.statusCode());
    ...
    public void unhandledExceptionWithRetryBlocking() throws InterruptedException {
        ...
        HttpClientRequest request = client.get("/wsService/unhandledExceptionWithRetryBlocking?val=123&tmp=456", new Handler<HttpClientResponse>() {
            public void handle(HttpClientResponse resp) {
                resp.bodyHandler(body -> {
                    String val = body.getString(0, body.length());
                    System.out.println("--------exceptionInStringResponse: " + val+"  CODE: "+resp.statusCode());
