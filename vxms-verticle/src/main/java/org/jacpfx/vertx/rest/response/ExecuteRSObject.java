...
public class ExecuteRSObject extends ExecuteRSBasicObject {
    ...
    public void execute(HttpResponseStatus status, String contentType) {
        ...
        final ExecuteRSObject lastStep = new ExecuteRSObject(vertx, t, errorMethodHandler, context, headerMap, async, objectSupplier, encoder, errorHandler, errorHandlerObject, status.code(), retryCount, delay, timeout);
        lastStep.execute();
    }
    ...
    public void execute(String contentType) {
        ...
        Map<String, String> headerMap = new HashMap<>(headers);
        headerMap.put("content-type", contentType);
        final ExecuteRSObject lastStep = new ExecuteRSObject(vertx, t, errorMethodHandler, context, headerMap, async, objectSupplier, encoder, errorHandler, errorHandlerObject, httpStatusCode, retryCount, delay, timeout);
        lastStep.execute();
    }
