...
public class RSAsyncResponse {
    ...
    public ExecuteRSByteResponse byteResponse(ThrowableSupplier<byte[]> byteSupplier) {
        return new ExecuteRSByteResponse(vertx, t, errorMethodHandler, context, headers, async, byteSupplier, null, null, null, 0, 0, 0, 0);
    }
    ...
    public ExecuteRSStringResponse stringResponse(ThrowableSupplier<String> stringSupplier) {
        return new ExecuteRSStringResponse(vertx, t, errorMethodHandler, context, headers, async, stringSupplier, null, null, null, 0, 0, 0, 0);
    }
