...
public class ExecuteRSStringResponse extends ExecuteRSString {
    ...
    public ExecuteRSString onErrorResponse(Function<Throwable, String> errorHandlerString) {
        return new ExecuteRSString(vertx, t, errorMethodHandler, context, headers, async, stringSupplier, encoder, errorHandler, errorHandlerString, retryCount);
    }


    public ExecuteRSStringResponse onError(Consumer<Throwable> errorHandler) {
        return new ExecuteRSStringResponse(vertx, t, errorMethodHandler, context, headers, async, stringSupplier, encoder, errorHandler, errorHandlerString, retryCount);
    }
    ...
    public ExecuteRSString contentType(String contentType) {
        ...
        return new ExecuteRSString(vertx, t, errorMethodHandler, context, headerMap, async, stringSupplier, encoder, errorHandler, errorHandlerString, retryCount);
    }

    public ExecuteRSStringResponse putHeader(String key, String value) {
        Map<String, String> headerMap = new HashMap<>(headers);
        headerMap.put(key, value);
        return new ExecuteRSStringResponse(vertx, t, errorMethodHandler, context, headerMap, async, stringSupplier, encoder, errorHandler, errorHandlerString, retryCount);
    }
}
