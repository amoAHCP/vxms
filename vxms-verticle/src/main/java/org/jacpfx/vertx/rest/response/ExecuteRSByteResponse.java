...
public class ExecuteRSByteResponse extends ExecuteRSByte {
    ...
    public ExecuteRSByteResponse(Vertx vertx, Throwable t, Consumer<Throwable> errorMethodHandler, RoutingContext context, Map<String, String> headers, boolean async, ThrowableSupplier<byte[]> byteSupplier, Encoder encoder, Consumer<Throwable> errorHandler, Function<Throwable, byte[]> errorHandlerByte, int httpStatusCode, int retryCount, long timeout, long delay) {
        super(vertx, t, errorMethodHandler, context, headers, async, byteSupplier, encoder, errorHandler, errorHandlerByte, httpStatusCode, retryCount, timeout, delay);
    }
    ...
    public ExecuteRSByte onErrorResponse(Function<Throwable, byte[]> errorHandlerByte) {
        return new ExecuteRSByte(vertx, t, errorMethodHandler, context, headers, async, byteSupplier, encoder, errorHandler, errorHandlerByte, httpStatusCode, retryCount, timeout, delay);
    }

    public ExecuteRSByte contentType(String contentType) {
        Map<String, String> headerMap = new HashMap<>(headers);
        headerMap.put("content-type", contentType);
        return new ExecuteRSByte(vertx, t, errorMethodHandler, context, headerMap, async, byteSupplier, encoder, errorHandler, errorHandlerByte, httpStatusCode, retryCount, timeout, delay);
    }

    public ExecuteRSByteResponse onError(Consumer<Throwable> errorHandler) {
        return new ExecuteRSByteResponse(vertx, t, errorMethodHandler, context, headers, async, byteSupplier, encoder, errorHandler, errorHandlerByte, httpStatusCode, retryCount, timeout, delay);
    }
    ...
    public ExecuteRSByteResponse putHeader(String key, String value) {
        ...
        return new ExecuteRSByteResponse(vertx, t, errorMethodHandler, context, headerMap, async, byteSupplier, encoder, errorHandler, errorHandlerByte, httpStatusCode, retryCount, timeout, delay);
    }
}
